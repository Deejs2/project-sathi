    ...
    <div class="row">
        <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
              <?php include "../view/admin/common/sidebar.php"?>
            </div>
        </div>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            switch ($_GET['page']) {
                ...
                case 'contact':
                    ...
                    break;
                case 'package':
                    include "../view/admin/package.php";
                    break;
                case 'team':
                    include "../view/admin/team.php";
                    break;
                case 'project':
                    include "../view/admin/project.php";
                    break;
                case 'setting':
